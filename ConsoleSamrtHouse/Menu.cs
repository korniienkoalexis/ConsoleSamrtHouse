  ...
  public void Show()
        {
            ...
            devDictionary.Add("Radiola", Devises.GetRadioInstance());
            devDictionary.Add("LG", Devises.GetTVInstance());
            devDictionary.Add("Sony", Devises.GetMusicCenterInstance());
            devDictionary.Add("Libher", Devises.GetRefrigiratorInstance());
            devDictionary.Add("Midea", Devises.GetCondicionerInstance());
            ...
            while (true)
            {
                ...
                {
                    Console.WriteLine("Name: " + devs.Key + ", " + devs.Value.ToString());
                }
                        ...
                        if (!devDictionary.ContainsKey(commands[2]))
                        {
                            switch (commands[1].ToLower())
                            {
                                case "radio":
                                    ...
                                    devDictionary.Add(commands[2], Devises.GetRadioInstance(commands[2]));
                                    break;
                                case "tv":
                                    //devDictionary.Add(commands[2], new TV(true, commands[2], new TVChanneChangel(), new Volume()));
                                    devDictionary.Add(commands[2], Devises.GetTVInstance(commands[2]));
                                    break;
                                case "musiccenter":
                                    ...
                                    devDictionary.Add(commands[2], Devises.GetMusicCenterInstance(commands[2]));
                                    break;
                                case "fridge":
                                    //devDictionary.Add(commands[2], new Refrigerator(true, commands[2], new ChangeFrostMode(), false ,false));
                                    devDictionary.Add(commands[2], Devises.GetCondicionerInstance(commands[2]));
                                    break;
